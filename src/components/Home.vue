    ...
    <div class="room-info">
        ...
        <div class="swiper-container gallery-thumbs">
            <div class="swiper-wrapper tabMenu">
                <div class="swiper-slide cur" >生态直播</div>
                <div class="swiper-slide" >生态商城</div>
                <div class="swiper-slide" >互动评论</div>
                <div class="swiper-slide" >精彩短片</div>
            </div>
        </div>
            ...
            <div class="swiper-wrapper tabCon">
                <div class="swiper-slide con" >
                    ...
                    <div class="company">
                        ...
                        <div class="remarks">
                            <span>生态简介：</span>
                            <p class="hide">寒地黑土，一年种植一次。生米清香，米饭香甜劲道，松软可口不可回生。店家自产自销纯正五常稻花香大米，原生态种植，稻田里养鸭。</p>
                        </div>
                    </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $(".tabMenu .swiper-slide").click(function(){
            ...
            player = new Aliplayer({
                ...
                skinLayout:[
...

                    {
                        name: "controlBar", align: "blabs", x: 0, y: 0,
                        children: [
                            //{name:"liveDisplay", align:"tlabs", x: 20, y:},
                            {name: "progress", align: "blabs", x: 0, y: 44},
                            {name: "playButton", align: "tl", x: 15, y: 12},
                            {name: "timeDisplay", align: "tl", x: 10, y: 7},
                            {name: "fullScreenButton", align: "tr", x: 10, y: 12},
