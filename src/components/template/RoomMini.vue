              ...
              <div class="swiper-container scroll">
                <div class="swiper-wrapper">
                  <div class="swiper-slide slidescroll">
                    ...
                    <comments :room_id="room_id" @clearComment="clearParent" ref="comment"
                              v-if="showComment"></comments>
                  </div>
                </div>
              </div>
            </div>
    ...
    methods: {
      ...
      WxShare() {
        ...
        wx.miniProgram.postMessage({
          data: {
            title: that.roomBasic.title + " " + that.roomBasic.sub_title,
            desc: that.roomBasic.introduce,
            link: share_url,
            roomId: that.room_id
          }
        })
