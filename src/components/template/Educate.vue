    ...
    <div class="live-room-main">
      ...
      <div class="swiper-container gallery-thumbs">
        <div class="swiper-wrapper tabMenu">
          <div class="swiper-slide cur" @click="switchContent(0)">班级风采</div>
          <div class="swiper-slide" @click="switchContent(1)">课堂直播</div>
          <div class="swiper-slide" @click="switchContent(2)">家庭时光</div>
        </div>
      </div>
